...
/**
 * Dashboard del Donador — Diseño original de feat/donation-tracking-ui.
 * Layout con sidebar lateral y tema Lumera/Stitch.
 */
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.menu}>
          <button
            ...
            className={`${styles.menuItem} ${view === "inicio" ? styles.active : ""}`}
          >
            🏠 Inicio
          </button>
          <button
            onClick={() => setView("nueva-donacion")}
            className={`${styles.menuItem} ${view === "nueva-donacion" ? styles.active : ""}`}
          >
            📦 Nueva donación
          </button>
          <button
            onClick={() => setView("perfil")}
            className={`${styles.menuItem} ${view === "perfil" ? styles.active : ""}`}
          >
            👤 Perfil
          </button>
        </nav>
